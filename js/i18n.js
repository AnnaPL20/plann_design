...
window.PLANN_DICT = {
  en: {
    ...
    'card.sheet': 'Project', 'work.selected': 'Selected work', 'work.range': '2023 — 2026', 'work.density': 'Grid density',
    'card.sheet': 'Project', 'work.client': 'Client', 'work.case': 'Case', 'work.open': 'Open', 'work.category': 'Category', 'work.year': 'Year',
    ...
    'services.leadRow': 'From the first brief to the final file, I keep strategy, identity and content in one system.', 'services.headA': 'This is how I', 'services.exp': 'Let’s experiment', 'about.lead': 'I am Anna Pytsko, a graphic and web designer.', 'services.headB': 'work.',
    ...
    /* --- Uslugi: trzy kierunki z widelkami cenowymi --- */
    'sv.label': 'Services', 'sv.title': 'Three directions, one system.',
    'sv.lead': 'Pick a direction — inside you will find what it includes, how long it takes and where the price starts.',
    'sv.from': 'Price', 'sv.time': 'Time', 'sv.open': 'What is inside', 'sv.close': 'Close',
    'sv.note': 'Prices are a starting point. The final quote depends on scope, number of formats and deadline — I always send it after the brief.',
    'sv.cta': 'Ask for a quote',
    'sv.c1n': 'Brand identity',
    'sv.c1d': 'Everything that makes a brand recognisable: the idea, the mark, the system and the rules.',
    'sv.c1p': 'from €450', 'sv.c1t': '2–4 weeks',
    'sv.c1b1': 'Logo and mark with all working variants',
    'sv.c1b2': 'Colour, typography and the rules that hold them together',
    'sv.c1b3': 'Brand book — how to use the identity without me',
    'sv.c1b4': 'Packaging, print and product visuals',
    'sv.c1b5': 'Refresh of an identity that already exists',
    'sv.c2n': 'Web & digital',
    'sv.c2d': 'Sites that look like the brand and are built to be used, not only admired.',
    'sv.c2p': 'from €700', 'sv.c2t': '3–6 weeks',
    'sv.c2b1': 'Landing page — one clear story, one clear action',
    'sv.c2b2': 'Multi-page website with a reusable design system',
    'sv.c2b3': 'Responsive build in WordPress Elementor with custom CSS',
    'sv.c2b4': 'UX structure: what goes where and why',
    'sv.c2b5': 'Handover files for your developer',
    'sv.c3n': 'Social & content',
    'sv.c3d': 'Content that keeps one voice across every post, story and campaign.',
    'sv.c3p': 'from €180', 'sv.c3t': '1–2 weeks',
    'sv.c3b1': 'Template set for posts, stories and reel covers',
    'sv.c3b2': 'Campaign visuals and banner series',
    'sv.c3b3': 'Presentations and pitch decks',
    'sv.c3b4': 'Motion and short video for social',
    'sv.c3b5': 'AI visuals shaped into brand content',
    /* --- Czesto zadawane pytania --- */
    'fq.label': 'Good to know', 'fq.title': 'Questions I get asked most.',
    'fq.q1': 'How do we start?',
    'fq.a1': 'You fill in the brief or simply write to me — whichever is easier. I read it, ask a few questions and send back a proposal with scope, timeline and price. Nothing is paid before we agree on all three.',
    'fq.q2': 'Do we sign a contract?',
    'fq.a2': 'Yes. Every project runs on a written agreement: scope, deadlines, number of revision rounds, payment schedule and who owns the files at the end. You get it before any work starts.',
    'fq.q3': 'How does payment work?',
    'fq.a3': 'Usually 50% to reserve the dates and 50% before the final files are handed over. Larger projects can be split into stages. Invoice included.',
    'fq.q4': 'How many revisions are included?',
    'fq.a4': 'Two rounds of revisions at every stage are part of the price. Anything beyond that, or a change of direction after approval, is quoted separately — so there are no surprises.',
    'fq.q5': 'What do I get at the end?',
    'fq.a5': 'Source files, exports in every format you need and a short guide on how to use them. After the final payment the rights to use the work are yours.',
    'fq.q6': 'Why work with me?',
    'fq.a6': 'You talk to one person from the first sketch to the last file — no account managers, no lost briefs. I work in Ukrainian, Polish and English, and I keep strategy, identity and content in one visual system.',
    /* --- Zapowiedz sklepu na stronie glownej --- */
    'shp.label': 'Shop', 'shp.title': 'Templates ready to use today.',
    'shp.text': 'Social sets, presentation decks and identity kits — the same systems I build for clients, prepared so you can run them yourself.',
    'shp.cta': 'Go to shop',
    /* --- Obiekt 3D pod menu --- */
    'd3.label': 'Object', 'd3.hint': 'Scroll to turn · move the cursor to light it',
  ...
  uk: {
    ...
    'card.sheet': 'Проєкт', 'work.selected': 'Вибрані роботи', 'work.range': '2023 — 2026', 'work.density': 'Щільність сітки',
    'card.sheet': 'Проєкт', 'work.client': 'Клієнт', 'work.case': 'Кейс', 'work.open': 'Відкрити', 'work.category': 'Категорія', 'work.year': 'Рік',
    ...
    'services.leadRow': 'Від першого брифу до фінального файлу я тримаю стратегію, айдентику й контент в одній системі.', 'services.headA': 'Ось як я', 'services.exp': 'Поекспериментуймо', 'about.lead': 'Я Анна Питсько, графічна та веб-дизайнерка.', 'services.headB': 'працюю.',
    ...
    /* --- Uslugi: trzy kierunki z widelkami cenowymi --- */
    'sv.label': 'Послуги', 'sv.title': 'Три напрями, одна система.',
    'sv.lead': 'Обери напрям — усередині видно, що входить, скільки часу займає і від якої суми починається.',
    'sv.from': 'Ціна', 'sv.time': 'Термін', 'sv.open': 'Що всередині', 'sv.close': 'Згорнути',
    'sv.note': 'Ціни — це старт. Фінальна сума залежить від обсягу, кількості форматів і терміну — я завжди надсилаю її після брифу.',
    'sv.cta': 'Запитати прорахунок',
    'sv.c1n': 'Айдентика бренду',
    'sv.c1d': 'Усе, що робить бренд впізнаваним: ідея, знак, система і правила.',
    'sv.c1p': 'від €450', 'sv.c1t': '2–4 тижні',
    'sv.c1b1': 'Логотип і знак з усіма робочими варіантами',
    'sv.c1b2': 'Колір, типографіка і правила, що тримають їх разом',
    'sv.c1b3': 'Брендбук — як користуватися айдентикою без мене',
    'sv.c1b4': 'Пакування, друк і продуктові візуали',
    'sv.c1b5': 'Оновлення айдентики, яка вже існує',
    'sv.c2n': 'Веб і цифра',
    'sv.c2d': 'Сайти, які виглядають як бренд і зроблені, щоб ними користувалися, а не лише милувалися.',
    'sv.c2p': 'від €700', 'sv.c2t': '3–6 тижнів',
    'sv.c2b1': 'Лендінг — одна чітка історія й одна чітка дія',
    'sv.c2b2': 'Багатосторінковий сайт із дизайн-системою',
    'sv.c2b3': 'Адаптивна збірка у WordPress Elementor із власним CSS',
    'sv.c2b4': 'UX-структура: що де стоїть і чому',
    'sv.c2b5': 'Файли передачі для твого розробника',
    'sv.c3n': 'Соцмережі та контент',
    'sv.c3d': 'Контент, який тримає один голос у кожному пості, сторіс і кампанії.',
    'sv.c3p': 'від €180', 'sv.c3t': '1–2 тижні',
    'sv.c3b1': 'Набір шаблонів для постів, сторіс і обкладинок reels',
    'sv.c3b2': 'Візуали кампаній і серії банерів',
    'sv.c3b3': 'Презентації та пітч-деки',
    'sv.c3b4': 'Моушн і коротке відео для соцмереж',
    'sv.c3b5': 'AI-візуали, доведені до брендового контенту',
    /* --- Czesto zadawane pytania --- */
    'fq.label': 'Варто знати', 'fq.title': 'Питання, які ставлять найчастіше.',
    'fq.q1': 'Як ми починаємо?',
    'fq.a1': 'Ти заповнюєш бриф або просто пишеш мені — як зручніше. Я читаю, ставлю кілька питань і надсилаю пропозицію з обсягом, термінами й ціною. Жодних оплат, поки ми не домовилися про всі три пункти.',
    'fq.q2': 'Чи підписуємо договір?',
    'fq.a2': 'Так. Кожен проєкт іде за письмовою угодою: обсяг, терміни, кількість кіл правок, графік оплат і кому належать файли в кінці. Ти отримуєш її до старту роботи.',
    'fq.q3': 'Як відбувається оплата?',
    'fq.a3': 'Зазвичай 50% — щоб зарезервувати дати, і 50% — перед передачею фінальних файлів. Великі проєкти можна розбити на етапи. Рахунок додається.',
    'fq.q4': 'Скільки правок входить у ціну?',
    'fq.a4': 'Два кола правок на кожному етапі входять у вартість. Усе понад це або зміна напряму після затвердження прораховується окремо — щоб не було несподіванок.',
    'fq.q5': 'Що я отримую в кінці?',
    'fq.a5': 'Вихідні файли, експорти в усіх потрібних форматах і коротку інструкцію, як ними користуватися. Після фінальної оплати права на використання роботи — твої.',
    'fq.q6': 'Чому варто працювати зі мною?',
    'fq.a6': 'Ти спілкуєшся з однією людиною від першого ескізу до останнього файлу — без акаунт-менеджерів і загублених брифів. Я працюю українською, польською та англійською і тримаю стратегію, айдентику й контент в одній візуальній системі.',
    /* --- Zapowiedz sklepu na stronie glownej --- */
    'shp.label': 'Магазин', 'shp.title': 'Шаблони, якими можна користуватися вже сьогодні.',
    'shp.text': 'Набори для соцмереж, презентації та стартові комплекти айдентики — ті самі системи, що я роблю клієнтам, зібрані так, щоб ними можна було користуватися самостійно.',
    'shp.cta': 'Перейти в магазин',
    /* --- Obiekt 3D pod menu --- */
    'd3.label': 'Обʼєкт', 'd3.hint': 'Гортай, щоб обертати · веди курсором, щоб підсвітити',
  ...
  pl: {
    ...
    'card.sheet': 'Projekt', 'work.selected': 'Wybrane prace', 'work.range': '2023 — 2026', 'work.density': 'Gestosc siatki',
    'card.sheet': 'Projekt', 'work.client': 'Klient', 'work.case': 'Case', 'work.open': 'Otwórz', 'work.category': 'Kategoria', 'work.year': 'Rok',
    ...
    'services.leadRow': 'Od pierwszego briefu po finalny plik trzymam strategię, identyfikację i treści w jednym systemie.', 'services.headA': 'Tak właśnie', 'services.exp': 'Poeksperymentujmy', 'about.lead': 'Jestem Anna Pytsko, projektantka graficzna i webowa.', 'services.headB': 'pracuję.',
    ...
    /* --- Uslugi: trzy kierunki z widelkami cenowymi --- */
    'sv.label': 'Usługi', 'sv.title': 'Trzy kierunki, jeden system.',
    'sv.lead': 'Wybierz kierunek — w środku widać, co wchodzi w zakres, ile to trwa i od jakiej kwoty się zaczyna.',
    'sv.from': 'Cena', 'sv.time': 'Czas', 'sv.open': 'Co jest w środku', 'sv.close': 'Zwiń',
    'sv.note': 'Ceny są punktem wyjścia. Ostateczna kwota zależy od zakresu, liczby formatów i terminu — zawsze wysyłam ją po briefie.',
    'sv.cta': 'Poproś o wycenę',
    'sv.c1n': 'Identyfikacja marki',
    'sv.c1d': 'Wszystko, co sprawia, że markę widać: pomysł, znak, system i zasady.',
    'sv.c1p': 'od €450', 'sv.c1t': '2–4 tygodnie',
    'sv.c1b1': 'Logo i znak ze wszystkimi wariantami roboczymi',
    'sv.c1b2': 'Kolor, typografia i zasady, które trzymają je razem',
    'sv.c1b3': 'Księga znaku — jak używać identyfikacji beze mnie',
    'sv.c1b4': 'Opakowania, druk i wizualizacje produktu',
    'sv.c1b5': 'Odświeżenie istniejącej identyfikacji',
    'sv.c2n': 'Web i cyfra',
    'sv.c2d': 'Strony, które wyglądają jak marka i są zrobione do używania, nie tylko do oglądania.',
    'sv.c2p': 'od €700', 'sv.c2t': '3–6 tygodni',
    'sv.c2b1': 'Landing page — jedna jasna historia i jedno jasne działanie',
    'sv.c2b2': 'Serwis wielostronicowy z systemem projektowym',
    'sv.c2b3': 'Responsywne wdrożenie w WordPress Elementor z własnym CSS',
    'sv.c2b4': 'Struktura UX: co gdzie stoi i dlaczego',
    'sv.c2b5': 'Pliki przekazania dla Twojego programisty',
    'sv.c3n': 'Social media i treści',
    'sv.c3d': 'Treści, które trzymają jeden głos w każdym poście, story i kampanii.',
    'sv.c3p': 'od €180', 'sv.c3t': '1–2 tygodnie',
    'sv.c3b1': 'Zestaw szablonów na posty, stories i okładki rolek',
    'sv.c3b2': 'Wizualizacje kampanii i serie banerów',
    'sv.c3b3': 'Prezentacje i pitch decki',
    'sv.c3b4': 'Motion i krótkie wideo do social mediów',
    'sv.c3b5': 'Wizualizacje AI doprowadzone do treści marki',
    /* --- Czesto zadawane pytania --- */
    'fq.label': 'Warto wiedzieć', 'fq.title': 'Pytania, które słyszę najczęściej.',
    'fq.q1': 'Jak zaczynamy?',
    'fq.a1': 'Wypełniasz brief albo po prostu piszesz — jak Ci wygodniej. Czytam, dopytuję o kilka rzeczy i odsyłam propozycję z zakresem, terminem i ceną. Nic nie płacisz, zanim nie ustalimy wszystkich trzech.',
    'fq.q2': 'Czy podpisujemy umowę?',
    'fq.a2': 'Tak. Każdy projekt idzie na pisemnej umowie: zakres, terminy, liczba rund poprawek, harmonogram płatności i to, do kogo należą pliki na końcu. Dostajesz ją przed startem prac.',
    'fq.q3': 'Jak wygląda płatność?',
    'fq.a3': 'Zwykle 50% przy rezerwacji terminu i 50% przed przekazaniem finalnych plików. Większe projekty można podzielić na etapy. Faktura w komplecie.',
    'fq.q4': 'Ile poprawek jest w cenie?',
    'fq.a4': 'Dwie rundy poprawek na każdym etapie są wliczone. Wszystko ponad to albo zmiana kierunku po akceptacji wyceniam osobno — żeby nie było niespodzianek.',
    'fq.q5': 'Co dostaję na końcu?',
    'fq.a5': 'Pliki źródłowe, eksporty we wszystkich potrzebnych formatach i krótką instrukcję, jak ich używać. Po ostatniej płatności prawa do korzystania z pracy są Twoje.',
    'fq.q6': 'Dlaczego warto ze mną pracować?',
    'fq.a6': 'Rozmawiasz z jedną osobą od pierwszego szkicu do ostatniego pliku — bez account managerów i gubionych briefów. Pracuję po ukraińsku, polsku i angielsku, a strategię, identyfikację i treści trzymam w jednym systemie wizualnym.',
    /* --- Zapowiedz sklepu na stronie glownej --- */
    'shp.label': 'Sklep', 'shp.title': 'Szablony gotowe do użycia od dziś.',
    'shp.text': 'Zestawy do social mediów, prezentacje i startowe komplety identyfikacji — te same systemy, które robię klientom, przygotowane tak, żeby poprowadzić je samodzielnie.',
    'shp.cta': 'Przejdź do sklepu',
    /* --- Obiekt 3D pod menu --- */
    'd3.label': 'Obiekt', 'd3.hint': 'Przewijaj, żeby obracać · prowadź kursorem, żeby podświetlić',
